...
urlpatterns = patterns('api',
    ...
    url(r'^champion$', ChampionList.as_view(), name='champion-list'),
    url(r'^champion/(?P<name>\w+)$', ChampionDetail.as_view(), name='champion-detail'),
    url(r'^items$', ItemList.as_view(), name='item-list'),
    url(r'^items/(?P<name>\w+)$', ItemDetail.as_view(), name='item-detail'),
    url(r'^spells$', SummonerSpellList.as_view(), name='spell-list'),
    url(r'^spells/(?P<name>\w+)$', SummonerSpellDetail.as_view(), name='spell-detail'),
    url(r'^players$', PlayerList.as_view(), name='player-list'),
    url(r'^players/(?P<name>\w+$)', PlayerDetail.as_view(), name='player-detail'),
    ...
    url(r'^games/(?P<region>\w+)/(?P<name>\w+$)', GameList.as_view(), name='game-region-name-list'),
)