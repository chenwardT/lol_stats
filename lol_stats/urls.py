...
# TODO: Get non-viewset views into API root
# Check out following links to get Summoners in API Root generated by the router
# http://stackoverflow.com/questions/18817988/using-django-rest-frameworks-browsable-api-with-apiviews
# https://groups.google.com/forum/#!topic/django-rest-framework/wU_m04j4Q0w

urlpatterns = patterns('',
    # All api.* routes are purely for testing, in production, views should come from a different app.
    # these regexs are NOT robust!
